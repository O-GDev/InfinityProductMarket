...
const landingpage = () => {
  ...
  const [ professionalsData, setProfessionalData] = useState()
...
<Button className='flex items-center justify-center'><div className='font-bold id p-3' style={{ backgroundColor: 'transparent', borderColor: '#702EB2', borderWidth: 1, color: '#702EB2' }}>Let's&nbsp; Deal</div></Button>
            ...
            <div className='w-full flex justify-center items-center'>
              <div className='flex flex-col justify-center items-center self-center px-5 '>
                ...
                <motion.p
                  ...
                  whileInView="visible"
                  transition={{duration: 1,  }}
                  className='md:px-16 px-4 text-center self-center text-[90%] md:text-lg'>Check out our top notch professionals in different fields  of creativity all across the world. </motion.p>
                <motion.div
                  variants={{
                    hidden: { opacity: 0, y: 50 },
                    visible: { opacity: 1, y: 0 }
            ...
            <div className='flex w-full items-center'>
              <div className='flex flex-col justify-center self-center '>
                ...
                <motion.p
                  ...
                  whileInView="visible"
                  transition={{duration: 1,  }}
                  className='md:px-16 px-9 text-center text-[90%] md:text-lg'>More than an e-commerce platform, we are a thriving community. INFINITY MARKET PLACE serves as a meeting ground for creators, connoisseurs, and those who appreciate the finer things in life.</motion.p>
                <motion.div
                  variants={{
                    hidden: { opacity: 0, y: 50 },
                    visible: { opacity: 1, y: 0 }
            ...
            <div>
              <div className='flex flex-col justify-center items-center self-center'>
                ...
                <motion.p
                  ...
                  whileInView="visible"
                  transition={{duration: 1,  }}
                  className='md:px-16 px-9 text-center self-center text-[90%] md:text-lg'>
      ...
      <div>
        ...
        <div className='md:columns-4 h-full columns-2 md:gap-3 p-1 md:p-0 '>
          {topRatedData.map((topRated, index) => (
            <motion.div
              ...
              key={index} 
              className='py-3 lg:py-0 md:px-0'
              >
              <Cards image={topRated.image} pname={topRated.pname} pprice={topRated.pprice} rate={topRated.rate} radius='xl' height='300px' width='full' />
            </motion.div>
          ))}
        </div>
        </div>
      ...
      <></>}
        ...
        <div className='md:columns-4 flex flex-col md:flex-row justify-between md:m-1 p-5 px-20 '>
          {professionalsData.map((professional, index) => (
            <motion.div
              // variants={}image, opa, padin, radius,width, height
              initial={{ opacity: 0, y: 70 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.05 * index, duration: 0.5 * index }}
              key={index}
            ...
            >
              <div className='rounded-full w-[200px] h-[200px] bg-red-900 bg-cover bg-center bg-no-repeat' style={{backgroundImage:`url(${professional.image}`}} ></div>
