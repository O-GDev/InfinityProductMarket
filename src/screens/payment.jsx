...
// transition = {{ duration: 1 }}
  return (
    ...
    <div className='h-full sm:py-10 p-5 md:p-10 flex flex-col justify-center self-center ' style={{}}>
      ...
      <div className='columns-3 flex gap-3 p-12 md:pt-28 justify-between w-full self-center'>
              <img src='/assets/Frame 427319632.png' className='flex self-center'  width='10%' height='10%' alt='' />
              <img src='/assets/Frame 427319633.png' className='flex self-center'  width='10%' height='10%' alt='' />
              <img src='/assets/Frame 427319634.png' className='flex self-center'  width='10%' height='10%' alt='' />
      </div>

      <div className='columns-3 justify-between flex gap-3 p-12'>
              <img src='/assets/Frame 427319635.png' className='flex self-center'  width='10%' height='10%' alt='' />
              <img src='/assets/Frame 427319636.png' className='flex self-center'  width='10%' height='10%' alt='' />
              <img src='/assets/Frame 427319637.png' className='flex self-center'  width='10%' height='10%' alt='' />
     </div>
