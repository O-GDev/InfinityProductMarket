      ...
      <div>
        <div className='md:columns-2 justify-center md:mx-36 my-12 '>
          ...
          <h2 className='pt-16 text-center text-lg font-bold font-primary'>Curated Exellence</h2>
            <p className='md:px-36 text-center'>Check out our top notch professionals in different fields  of creativity all across the world. </p>
      ...
      <div>
        <div className='md:columns-2 md:mx-36 my-12'>          
          ...
          <h2 className='md:pt-16 text-center text-lg font-bold font-primary'>Community and Connection</h2>
            <p className='md:px-36 text-center'>More than an e-commerce platform, we are a thriving community. INFINITY MARKET PLACE serves as a meeting ground for creators, connoisseurs, and those who appreciate the finer things in life.</p>
            <Button><span className='font-bold' style={{backgroundColor:'transparent',padding:'10px',borderColor:'#702EB2',borderWidth:1,color:'#702EB2'}}>Learn More</span></Button>
          </div>
          </div>
          <div className='p-3'>
      ...
      <div>
        <div className='md:columns-2 md:mx-36 my-12'>
          ...
          <h2 className='md:pt-16 text-center text-lg font-bold font-primary'>Trust and Transparency</h2>
            <p className='md:px-36 text-center'>Trust is the cornerstone of INFINITY MARKET PLACE. Rigorous verification protocols ensure the authenticity of creators and the security of every transaction.</p>
            <Button><span className='font-bold' style={{backgroundColor:'transparent',padding:'10px',borderColor:'#702EB2',borderWidth:1,color:'#702EB2'}}>Learn More</span></Button>
          </div>
          </div>
        </div>
