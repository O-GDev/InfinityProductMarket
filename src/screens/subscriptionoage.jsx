...
business on the right part</p>
          ...
          <div className='py-2 ml-2 rounded-3xl shadow-2xl' style={{backgroundColor:'#DEDEDE',}}>
          ...
          <div className='py-2 ml-2 rounded-3xl shadow-2xl' style={{backgroundColor:'#FFFEFC',}}>
