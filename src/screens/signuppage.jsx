                            ...
                            <div className='md:px-10 px-5 '>
                                <div className='md:flex justify-between md:my-2 max-w-full'>
                                    <div className='w-full md:px-3'>
                                        <h5 className='font-md text-[80%]'>First Name<span style={{ color: '#D69999' }}>*</span></h5>
                                    ...
                                    <div className='w-full md:px-3 my-2 md:my-0'>
                                        <h5 className='font-md text-[80%]'>Surname<span style={{ color: '#D69999' }}>*</span></h5>
                                        <input name='fName' className='rounded-2xl bg-white drop-shadow-lg border-gray-300 border-2 px-2 py-1 w-full ' style={{}} />
                                    </div>
                                </div>

                                <div className='my-2 md:px-3 md:my-0'>
                                    <h5 className='font-md text-[80%]'>Email Address<span style={{ color: '#D69999' }}>*</span></h5>
                                    <input name='fName' className='rounded-2xl bg-white drop-shadow-lg border-gray-300 border-2 px-2 py-1 w-full' style={{}} />
                                </div>

                                <div className='md:flex justify-between my-2 max-w-full'>
                                    <div className='w-full md:px-3'>
                                        <h5 className='font-md text-[80%]'>Password<span style={{ color: '#D69999' }}>*</span></h5>
                                        <input name='fName' className='rounded-2xl bg-white drop-shadow-lg border-gray-300 border-2 px-2 py-1 w-full' style={{}} />
                                    </div>
                                    <div className='w-full md:px-3 my-2 md:my-0'>
                                        <h5 className='font-md text-[80%]'>Confirm Password<span style={{ color: '#D69999' }}>*</span></h5>
                                        <input name='fName' className='rounded-2xl bg-white drop-shadow-lg border-gray-300 border-2 px-2 py-1 w-full' style={{}} />
                                    </div>
                                </div>
                                ...
                                <div className='flex self-center md:px-3'>
                                    ...
                                    <h5 className='text-[80%]'>I agree to the Terms, Condition and Privacy Policy</h5>
                                </div>
                                ...
                                <div className='flex justify-center'>
                                    <h4 className='pb-2 text-[80%]'>Already have an account? <span style={{ color: '#702EB2' }}>Log In</span></h4>
                                </div>
